...
export declare function btcSignTx(wallet: core.BTCWallet, transport: Transport, msg: core.BTCSignTxKK): Promise<core.BTCSignedTx>;
...
export declare function btcGetAccountPaths(msg: core.BTCGetAccountPaths): Array<core.BTCAccountPath>;
export declare function btcIsSameAccount(msg: Array<core.BTCAccountPath>): boolean;

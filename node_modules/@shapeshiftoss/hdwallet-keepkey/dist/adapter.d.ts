...
export declare class Adapter<DelegateType extends AdapterDelegate<any>> {
    ...
    pairDevice(serialNumber?: string, tryDebugLink?: boolean): Promise<core.HDWallet>;
    pairRawDevice(device: DeviceType<DelegateType>, tryDebugLink?: boolean): Promise<core.HDWallet>;
}

...
export declare class Transport extends core.Transport {
    ...
    call(msgTypeEnum: number, msg: jspb.Message, msgTimeout?: number, omitLock?: boolean, noWait?: boolean): Promise<any>;
    callDebugLink(msgTypeEnum: number, msg: jspb.Message, msgTimeout?: number, omitLock?: boolean, noWait?: boolean): Promise<any>;
    cancel(): Promise<void>;
